...
<div class="content mt-3">
    ...
    <div class="col-xl-4 col-lg-6">
        <section class="card">
            <div class="twt-feed blue-bg">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h2 class="text-white display-6">Huy Phước</h2>
            ...
            <footer class="twt-footer text-center">
        ...
        <section class="card">
            <div class="twt-feed blue-bg">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h2 class="text-white display-6">Thanh Tôn</h2>
        ...
        <section class="card">
            <div class="twt-feed blue-bg">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h2 class="text-white display-6">Minh Nhật</h2>
                        <p class="text-light">Tech Lead</p>
                    </div>
                </div>
            </div>
            <div class="weather-category twt-category">
