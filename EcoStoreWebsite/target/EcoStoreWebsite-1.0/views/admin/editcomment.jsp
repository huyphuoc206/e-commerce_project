                    ...
                    <div class="card-body card-block">
                        <form id="formSubmit" action="" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row justify-content-center">
                                <button id="updateComment" type="button" class="btn btn-primary btn-sm mr-2">
    ...
    function updateComment(data) {
        ...
        $.ajax({
            ...
            success: function (result) {
                $('.load').hide();
                if (result !== null)
                    window.location.href = "${CommentUrl}?message=update_success&alert=success";
                else
                    window.location.href = "${CommentUrl}?message=update_fail&alert=danger";
            },
